...
С тем, как работают соответствующие алгоритмы, как происходит процесс тестирования и генерация тестов можно ознакомиться более подробно в документе [paper.pdf](static_files/paper.pdf).
